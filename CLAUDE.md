...
- `make deploy` — cross-compile + rsync to archer (server, systemd restart), marko (linux/amd64), hornet (darwin/arm64), and install locally. Run when the server or remote hosts are affected.
